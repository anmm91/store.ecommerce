                ...
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">اضافه ماركه
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <form class="form" action="{{ route('store.brands')}}" method="POST"
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <img src="{{asset('/')}}" style="width:100px"  name="image" class="img-thumbnail image-preview">
