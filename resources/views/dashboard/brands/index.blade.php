                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            @foreach($brands as $brand)
                                                ...
                                                <tr>
                                                    <td>{{ $brand->name }} </td>
                                                    <td> <img style="width:75px;height:75px" src="{{ $brand->photo }}"> </td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group" role="group"
                                                            ...
                                                            <a href="{{ route('activate.brands',$brand->id) }}"
                                                               class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">
                                                               {{ $brand->is_active == 1 ? 'تعليق' : 'تفعيل' }}
                                                            </a>
                                                            <form method="post" action="{{ route('delete.brands',$brand->id) }}">
                                                               @csrf
                                                                <button type="submit"
                                                                    value=""
                                                                    onclick=""
